...
add wave -noupdate -group Datapath(local) /system_tb/DUT/CPU/DP/bneaddr
add wave -noupdate -group Datapath(local) /system_tb/DUT/CPU/DP/jraddr
add wave -noupdate -group Datapath(local) /system_tb/DUT/CPU/DP/jaddr
add wave -noupdate -group Datapath(local) /system_tb/DUT/CPU/DP/br_nottaken
add wave -noupdate -group Datapath(local) /system_tb/DUT/CPU/DP/PCSrc_br
add wave -noupdate -group Datapath(local) /system_tb/DUT/CPU/DP/beqaddr
add wave -noupdate -group Datapath(local) /system_tb/DUT/CPU/DP/branch_op
add wave -noupdate -group Datapath(local) /system_tb/DUT/CPU/DP/beq
...
WaveRestoreCursors {{Cursor 1} {331230 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1445006 ps}
